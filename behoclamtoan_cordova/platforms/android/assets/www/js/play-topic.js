var myapp = angular.module('play-topic', ['ngSanitize']);
 myapp.controller('myplay-topic', function($scope, $http) {
	...
	$http.get(url_service + 'QuestionController/getQuestionExamTopicById/' + id)
