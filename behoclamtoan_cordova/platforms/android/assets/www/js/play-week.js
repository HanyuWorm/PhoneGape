var myapp = angular.module('play-week', ['ngSanitize']);
 myapp.controller('myplay-week', function($scope, $http) {
	...
	$http.get(url_service + 'QuestionWeekController/getQuestionWeekById/' + Id)
